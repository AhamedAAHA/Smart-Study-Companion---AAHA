        ...
        <section className="card">
          ...
          <form onSubmit={handleSubmit} className="mt-6 grid gap-4 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
              ...
              <option value="tamil_english">Tamil–English mix</option>
              <option value="sinhala_english">Sinhala–English mix</option>
              <option value="student_lk">Sri Lankan student style</option>
              </select>
            </div>
            {error && (
              <p className="sm:col-span-2 animate-fade-in text-sm text-danger" role="alert">
                {error}
              </p>
            )}
            <button
